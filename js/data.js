...
const MAP_UI = {
  th: {
    ...
    architecture: '📐 Architecture / สถาปัตยกรรม',
...
const DEFAULT_ITINERARY = [
  ...
  { day: 4, date: 'ศ. 23 ต.ค.', area: 'fukushima', title: 'เต็มวัน ① — 🚗 ขับรถเที่ยวธรรมชาติ Urabandai (ไม่เหนื่อย)', items: [
    ...
    { t: '08:00', act: '🚗 รับรถเช่าที่สาขาใกล้สถานี Fukushima', note: 'ดูสาขา+ลิงก์จองในหมวด「การเดินทาง → 🚗 ร้านเช่ารถ」· เช่า 2 วัน (23-24) คืนรถเย็นวันพรุ่งนี้หลังเดินเขา · ค่ารถ/น้ำมันวันนี้ (ครึ่งหนึ่งของ 2 วัน) ≈ ¥3,440/คน — ดูสรุปเต็มในกล่อง 🚗 คุ้มไหมถ้าเช่ารถ', tag: 'move', cost: 3440 },
    { t: '08:30', act: 'ออกทาง Tohoku Expressway → ทางด่วนล้วน ไม่ผ่านภูเขา', note: 'เลี่ยง Bandai-Azuma Skyline (ทางภูเขาโค้งเยอะ 28.7 กม. ขับ 90 นาที เหนื่อยกว่า และใบไม้บนที่สูงมักพีคไปแล้วตั้งแต่ต้น-กลาง ต.ค.) — ไปทางด่วนสบายกว่าและตรงจังหวะใบไม้ของปีนี้กว่า', tag: 'move', cost: 0 },
    { t: '09:15', act: '📸 หุบเขา Nakatsugawa — จุดถ่ายรูปใบไม้แดงชื่อดังของ Urabandai', note: 'จอดที่ Nakatsugawa Rest House แล้วเดินลงสะพานแค่ ~5 นาที ทางราบเรียบ ไม่เหนื่อยเลย · หินขัดมันจากกระแสน้ำ + ป่าเมเปิลรอบหุบ · จุดถ่ายภาพสวยระดับที่ช่างภาพมาจากทั่วประเทศ', tag: 'nature', cost: 0 },
    { t: '09:50', act: '🥾 เดินเข้า Goshiki-numa แบบไป-กลับสั้น ๆ (ไม่ต้องเดินทะลุ)', note: 'จอดรถที่ Goshikinuma Iriguchi เดินเข้าไปถึง Bishamon-numa บึงสีสวยที่สุด (~15-20 นาที/ขา) แล้วเดินย้อนกลับมาที่รถ — รวม ~40-50 นาที ทางราบล้วน ไม่ต้องเดินทะลุออกอีกฝั่งแบบตอนไม่มีรถ (ปกติคนไม่มีรถต้องเดินทะลุ 3.6 กม. 80-90 นาทีเพราะรถบัสจอดคนละฝั่ง) · ใบไม้พีคกลาง ต.ค.–ต้น พ.ย. — ตรงช่วงเราพอดี', tag: 'nature', cost: 0 },
    { t: '11:00', act: 'ขับรถ ~10 นาที ไปข้าวเที่ยงแถว Urabandai Kogen', note: 'ร้านอาหาร/คาเฟ่รวมกันแถวนี้ ที่จอดรถสะดวก', tag: 'food', cost: 1200 },
    { t: '13:00', act: '🚤 ล่องเรือทะเลสาบ Hibara ~35 นาที', note: 'เปิดปลาย เม.ย.–ต้น พ.ย. — ปลาย ต.ค. ยังทัน · ~¥1,500 · นั่งเรือชมวิว ไม่ต้องเดิน พักขาได้เต็มที่ · จุดขายตั๋ว/ที่จอดรถอยู่ติดกัน', tag: 'nature', cost: 1500 },
    { t: '14:00', act: 'นั่งชิลริมทะเลสาบ · คาเฟ่ · ร้านของฝาก', note: 'วันนี้ตั้งใจให้เหลือเวลาไม่ต้องรีบ ไม่มีตารางรถบัสมากำหนด — ต่างจากวันเดินเขาพรุ่งนี้ที่มีเดดไลน์', tag: 'nature', cost: 800 },
    { t: '15:30', act: '🚗 ขับกลับ Fukushima ทางด่วน', note: '~45-50 นาที · ทางเดียวกับขามา ไม่ต้องขับใหม่ ไม่เหนื่อย', tag: 'move', cost: 0 },
    { t: '16:30', act: '♨️ ถึงเมือง — เลือกอย่างใดอย่างหนึ่งตามแรงที่เหลือ', note: 'A) Iizaka Onsen + Sabakoyu (~¥200 + ค่ารถ) · B) light-up อุโมงค์แปะก๊วย Azuma Sports Park (17:00–20:00) · C) กลับที่พักเลย จอดรถไว้ (ที่พักมีที่จอด) เตรียมของวันเดินเขา', tag: 'other', cost: 950 },
    { t: '19:30', act: '🥟 ข้าวเย็น · เตรียมของวันเดินเขา นอนเร็ว', note: 'พรุ่งนี้ตื่น 07:00 · รถยังอยู่ที่จอดของที่พัก ไม่ต้องคืนวันนี้', tag: 'food', cost: 1200 },
    { t: '—', act: '🔁 อยากเดินเต็มเส้น Goshiki-numa 3.6 กม. ทะลุสองฝั่ง', note: 'เดินฝั่ง Iriguchi → ออก Urabandai Kogen-eki (80-90 นาที) แล้วเดิน/แท็กซี่กลับมาเอารถที่จุดจอดเดิม — เหนื่อยกว่าแบบไป-กลับสั้น แต่เห็นบึงครบทุกจุด', tag: 'nature', cost: 0 },
    { t: '—', act: '🔁 ไม่มีรถ: แผนเดิมด้วยรถไฟ+บัส', note: 'Fukushima→Koriyama ชินคันเซ็น ¥1,800 → Inawashiro ¥770 → บัส Bandai Toto ¥790 → เดินทะลุ Goshiki-numa → เรือ Hibara → บัสกลับ → รถไฟกลับ (รวม ~¥8,000/คน) · ใช้เวลาทั้งวันเกือบเต็ม เพราะรอบบัสห่าง', tag: 'move', cost: 0 },
    { t: '—', act: '🔁 ถ้าไม่อยากขับไกล: ทะเลสาบ Inawashiro อย่างเดียว', note: 'อยู่ใกล้ทางด่วนกว่า ตัดช่วง Urabandai ออก ประหยัดเวลาขับรถ · ปลาย ต.ค. หงส์อพยพเริ่มมา', tag: 'nature', cost: 0 },
  ]},
...
/* ---------- map places ---------- */
const PLACES = [
  // Architecture shortlist — official visitor information checked 2026-09-19.
  {"name":"Matsugamine Catholic Church","ja":"カトリック松が峰教会","area":"tochigi","lat":36.558139,"lng":139.881333,"architecture":true,"url":"https://www.tochigiji.or.jp/spot/s7247/","ticket":"โบสถ์ใช้งานจริง · ตรวจเวลาเยี่ยมชมก่อนเข้า","desc":"Architecture · Max Hinder (1932) — โครงสร้างคอนกรีตกรุหิน Ōya กับหอคอยคู่โรมาเนสก์ ดูผิวหินและซุ้มโค้ง เหมาะแวะในเมืองคู่กับย่าน Ōya; เคารพช่วงประกอบพิธี","en":{"name":"Matsugamine Catholic Church","ticket":"Active church · check visiting arrangements before entering","desc":"Architecture · Max Hinder (1932): Oya-stone-clad concrete and Romanesque twin towers. Study the stone texture and arches; pair with the Oya district. Respect services."}},
  {"name":"Tamozawa Imperial Villa","ja":"日光田母沢御用邸記念公園","area":"nikko","lat":36.75257,"lng":139.59127,"architecture":true,"type":"museum","url":"https://www.nikko-kankou.org/spot/18","ticket":"ผู้ใหญ่ ¥600 · ต.ค. 09:00–17:00 เข้าก่อน 16:00 · 15 ต.ค.–14 พ.ย. เปิดทุกวันตามตารางปกติ","desc":"Architecture · พระตำหนักไม้ 106 ห้อง ดูลำดับห้อง ทางเดิน ชายคา และกรอบวิวสวน เลือกแทนบางจุดในเดย์ทริป; บัสจากสถานี Nikko ลง Tamozawa · หมุดในบริเวณพระตำหนัก","en":{"name":"Tamozawa Imperial Villa","ticket":"Adult ¥600 · October 09:00–17:00, last entry 16:00 · normally daily 15 Oct–14 Nov","desc":"Architecture · 106-room timber imperial villa: room sequences, corridors, eaves and framed garden views. Swap for another day-trip stop. Bus from Nikko to Tamozawa; pin marks the grounds."}},
  {"name":"Italian Embassy Villa — Antonin Raymond","ja":"イタリア大使館別荘記念公園","area":"nikko","lat":36.725056,"lng":139.485393,"architecture":true,"type":"museum","url":"https://www.nikko-kankou.org/spot/117","ticket":"ผู้ใหญ่ ¥300 / รวมบ้านพักอังกฤษ ¥450 · ต.ค. 09:00–17:00 เปิดทุกวันตามตารางปกติ","desc":"Architecture · Antonin Raymond (1928) — ลายตารางเปลือกและแผ่นไม้ซีดาร์ ระเบียงรับวิว Lake Chuzenji เหมาะต่อจากโซนทะเลสาบ; เดินราว 15 นาทีจากที่จอด Utagahama หรือเช็ครถบัสตามฤดูกาล · หมุดโดยประมาณบริเวณอาคาร","en":{"name":"Italian Embassy Villa — Antonin Raymond","ticket":"Adult ¥300 / combined with British villa ¥450 · October 09:00–17:00, normally daily","desc":"Architecture · Antonin Raymond (1928): cedar-bark and board checkerwork, with a lakeside veranda. Pair with Lake Chuzenji; about 15 minutes from Utagahama parking or check seasonal buses. Approximate building-area pin."}},
  {"name":"Fukushima City Minka-en","ja":"福島市民家園","area":"fukushima","lat":37.731194,"lng":140.372972,"architecture":true,"type":"museum","url":"https://fukushima.travel/destination/fukushima-city-minka-en-open-air-museum/124","ticket":"ฟรี · 09:00–16:30 · ปิดอังคารและช่วงปีใหม่","desc":"Architecture · บ้าน โรงเก็บของ และโรงละครเก่าที่ย้ายมารักษาไว้ ดูโครงไม้ หลังคา และพื้นที่ใช้ชีวิต อยู่ใน Azuma Sports Park จับคู่กับแปะก๊วยได้ · แนะนำเผื่อชม 1–2 ชม. และเช็คบัสขากลับ","en":{"name":"Fukushima City Minka-en","ticket":"Free · 09:00–16:30 · closed Tuesdays and New Year holidays","desc":"Architecture · Relocated historic houses, storehouses and a theatre: timber frames, roofs and domestic layouts. In Azuma Sports Park; pair with the ginkgo visit. Suggested visit 1–2 hours; check return buses."}},
  {"name":"Former Horikiri Residence — Iizaka","ja":"旧堀切邸","area":"fukushima","lat":37.8332669,"lng":140.4524253,"architecture":true,"type":"museum","url":"https://kyu-horikiritei.fckk.co.jp/","ticket":"ฟรี · 09:00–21:00 · อาจปิดชั่วคราวตามประกาศ","desc":"Architecture · บ้านตระกูลเกษตรกรและพ่อค้า กับยุ้งผนังดิน Jukkengura ดูโครงไม้ ผนังดิน และการวางอาคารรอบลาน มีบ่อแช่เท้า จับคู่กับ Iizaka Onsen · เดินราว 7 นาทีจากสถานี","en":{"name":"Former Horikiri Residence — Iizaka","ticket":"Free · 09:00–21:00 · occasional temporary closures","desc":"Architecture · Merchant/farming estate with the Jukkengura earthen storehouse: compare timber and earthen construction and courtyard layout. Footbath on site; pair with Iizaka Onsen. About 7 minutes from the station."}},
  // Setagaya Art Museum and nearby options — checked 2026-09-08; no fixed itinerary day.
  {"name":"Setagaya Art Museum — พิพิธภัณฑ์ศิลปะเซตากายะ","ja":"世田谷美術館","area":"tokyo","lat":35.63162,"lng":139.6222,"type":"museum","url":"https://www.setagayaartmuseum.or.jp/en/","ticket":"10:00–18:00 (เข้าก่อน 17:30) · ปิดจันทร์ · ราคาตามนิทรรศการ","desc":"จุดหลักของกลุ่ม Setagaya — ชมศิลปะแล้วเดินต่อในสวน Kinuta ได้เลย ช่วงทริปมีนิทรรศการสิ่งทอสวีเดน (19 ก.ย.–15 พ.ย. 2026) · 26 ต.ค. เป็นวันจันทร์ปิดตามปกติ จึงเลือก 27 ต.ค. หากสลับแผนมาเที่ยวโซนนี้","en":{"name":"Setagaya Art Museum","ticket":"10:00–18:00 (last entry 17:30) · closed Mondays · exhibition-dependent admission","desc":"Anchor for the Setagaya cluster, inside Kinuta Park. Swedish textiles exhibition: 19 Sep–15 Nov 2026. Mon 26 Oct is a regular closure; consider 27 Oct if swapping this area into the itinerary."}},
  {"name":"สวน Kinuta — เดินเล่นหลังชมพิพิธภัณฑ์","ja":"砧公園","area":"tokyo","lat":35.6290039,"lng":139.618335,"type":"spot","url":"https://www.tokyo-park.or.jp/park/kinuta/","desc":"กลุ่ม Setagaya — สวนเดียวกับพิพิธภัณฑ์ มีสนามหญ้ากว้าง แนวต้นไม้ และมุมดูนก เหมาะเดินพักหลังชมงานศิลปะ หมุดเป็นจุดภายในสวน เผื่อเวลาเดินเล่นประมาณ 30–60 นาทีตามความสนใจ","en":{"name":"Kinuta Park — Setagaya","desc":"The park surrounding Setagaya Art Museum: broad lawns, wooded paths and a bird sanctuary. A relaxed stop after the galleries. Pin marks a point inside the park; suggested visit 30–60 minutes."}},
  {"name":"Okamoto Park Minka-en — บ้านญี่ปุ่นโบราณ","ja":"岡本公園民家園","area":"tokyo","lat":35.6221807,"lng":139.618024,"type":"spot","url":"https://www.city.setagaya.lg.jp/02059/18906.html","ticket":"ฟรี · 09:30–16:30 · ปิดจันทร์ (ถ้าเป็นวันหยุด ปิดวันทำการถัดไป)","desc":"กลุ่ม Setagaya — ทางใต้ของสวน Kinuta ชมบ้านไร่เก่า เตาอิโรริ และเครื่องใช้พื้นบ้าน เหมาะกับคนชอบสถาปัตยกรรมญี่ปุ่นและบรรยากาศเงียบ ๆ · ต่อไปย่าน Futako-Tamagawa ได้ · 26 ต.ค. ปิดตามปกติ","en":{"name":"Okamoto Park Minka-en — Setagaya","ticket":"Free · 09:30–16:30 · closed Mondays (next weekday after a holiday Monday)","desc":"South of Kinuta Park: a restored farmhouse with an irori hearth and traditional household tools. A good stop for vernacular architecture before continuing toward Futako-Tamagawa. Regular closure on 26 Oct."}},
  {"name":"Futako-Tamagawa Park + สวนญี่ปุ่น Kishin-en","ja":"二子玉川公園・帰真園","area":"tokyo","lat":35.6081794,"lng":139.6334632,"type":"spot","url":"https://www.city.setagaya.lg.jp/02075/9194.html","ticket":"Kishin-en 09:00–17:00 ใน ต.ค. · สวนญี่ปุ่นปิดอังคาร (ยกเว้นวันหยุด)","desc":"ตัวเลือกต่อจากกลุ่ม Setagaya ลงไปฝั่งแม่น้ำ Tama — สวนเปิดโล่งและสวนญี่ปุ่น เดิน 9 นาทีจากสถานี Futako-Tamagawa อยู่ห่างพิพิธภัณฑ์ออกมา ควรเช็คเส้นทางรถใน Google Maps · 27 ต.ค. สวนญี่ปุ่นปิดตามปกติ แต่ยังเดินส่วนอื่นของสวนได้","en":{"name":"Futako-Tamagawa Park + Kishin-en Garden","ticket":"Kishin-en 09:00–17:00 in October · Japanese garden closed Tuesdays except holidays","desc":"An onward stop toward the Tama River from the Setagaya cluster: open parkland and a Japanese garden, 9 minutes on foot from Futako-Tamagawa Station. Farther from the museum; check transit in Google Maps. Kishin-en is normally closed on 27 Oct; the rest of the park remains an option."}},
  {"name":"Hasegawa Machiko Art Museum + Memorial Museum","ja":"長谷川町子美術館・記念館","area":"tokyo","lat":35.62798,"lng":139.64362,"type":"museum","url":"https://www.hasegawamachiko.jp/","ticket":"¥900 รวม 2 อาคาร · 10:00–17:30 (รับเข้าถึง 16:30) · ปิดจันทร์","desc":"กลุ่ม Setagaya — ต้นฉบับและโลกของ Sazae-san พร้อมคอลเลกชันศิลปะส่วนตัวของ Machiko Hasegawa · ช่วงทริปมีนิทรรศการครบรอบ 80 ปี ‘町子の余暇’ ถึง 8 พ.ย. 2026 · เดิน 7 นาทีจาก Sakura-shinmachi; จาก Setagaya Art Museum กลับไป Yoga แล้วนั่งรถไฟ 1 สถานี · 26 ต.ค. ปิด เลือก 27 ต.ค.","en":{"name":"Hasegawa Machiko Art Museum + Memorial Museum","ticket":"¥900 for both buildings · 10:00–17:30 (last admission 16:30) · closed Mondays","desc":"Setagaya cluster: original work and the world of Sazae-san alongside Machiko Hasegawa's private art collection. The 80th-anniversary exhibition ‘Machiko no Yoka’ runs through 8 Nov 2026. Seven minutes from Sakura-shinmachi; closed Mon 26 Oct, so visit on 27 Oct."}},
  {"name":"Gotoh Museum — ศิลปะญี่ปุ่น + สวนชา","ja":"五島美術館","area":"tokyo","lat":35.61244,"lng":139.63536,"type":"museum","url":"https://www.gotoh-museum.or.jp/event/schedule/","ticket":"27 ต.ค.–6 ธ.ค. 2026: ผู้ใหญ่ ¥1,400 · 10:00–17:00 (รับเข้าถึง 16:30) · ซื้อหน้างานได้","desc":"กลุ่ม Setagaya — อาคารของ Isoya Yoshida ผสานสถาปัตยกรรมญี่ปุ่นกับสวน เน้นศิลปะญี่ปุ่น/จีน งานเขียนพู่กัน ชา และเซรามิก · ปิดเปลี่ยนนิทรรศการ 13–26 ต.ค. แล้วเปิด ‘室町ごころの風景’ วันอังคาร 27 ต.ค. พอดี · เดิน 5 นาทีจาก Kaminoge; ต่อจาก Futako-Tamagawa เพียง 1 สถานีบนสาย Oimachi","en":{"name":"Gotoh Museum — Japanese art and garden","ticket":"27 Oct–6 Dec 2026: adults ¥1,400 · 10:00–17:00 (last admission 16:30) · tickets available at the museum","desc":"Setagaya cluster: Isoya Yoshida's Japanese-modern museum and garden, with Japanese and Chinese art, calligraphy, tea objects and ceramics. Closed for installation 13–26 Oct; ‘Landscapes of the Muromachi Spirit’ opens exactly on Tue 27 Oct. Five minutes from Kaminoge Station."}},
  {"name":"Todoroki Valley — ทางเดินหุบเขากลางโตเกียว","ja":"等々力渓谷","area":"tokyo","lat":35.60791,"lng":139.64663,"type":"spot","url":"https://www.city.setagaya.lg.jp/02075/9082.html","ticket":"ฟรี · ทางเดินริมลำธารเปิดอีกครั้งตั้งแต่ 24 มี.ค. 2026 · ไปช่วงกลางวัน","desc":"กลุ่ม Setagaya — หุบเขาธรรมชาติยาวราว 1 กม. ต่อไปสวนญี่ปุ่นและ Todoroki Fudoson ได้ · ทางเข้าใกล้สถานี Todoroki; จาก Gotoh Museum นั่งสาย Oimachi 2 สถานี เหมาะปิดท้ายคลัสเตอร์ · เช็คประกาศทางการอีกครั้งก่อนเดินเพราะอาจมีบางช่วงปิดบำรุง","en":{"name":"Todoroki Valley — Tokyo's urban ravine","ticket":"Free · riverside path reopened 24 Mar 2026 · visit in daylight","desc":"Setagaya cluster: an approximately 1 km natural ravine leading toward a Japanese garden and Todoroki Fudoson. The entrance is near Todoroki Station, two Oimachi Line stops from the Gotoh Museum. Recheck the official notice in case maintenance affects individual sections."}},
  // Tokyo
  ...
  { name: 'Oya History Museum', architecture: true, ja: '大谷資料館', area: 'tochigi', lat: 36.6009, lng: 139.8228, day: 3, desc: 'Architecture / วัสดุ — เหมืองหิน Ōya ใต้ดิน ดูรอยตัดหิน สเกลช่องว่าง และที่มาของวัสดุกรุโบสถ์ Matsugamine · อากาศเย็น ควรพกเสื้อคลุม',
    en: { name: 'Oya History Museum', desc: 'Architecture / materials — underground Oya stone quarry: extraction marks, cavern scale and the material used at Matsugamine Church. Cool inside; bring a jacket' } },
  ...
  { name: 'Utsunomiya Museum of Art', architecture: true, ja: '宇都宮美術館', area: 'tochigi', lat: 36.607072, lng: 139.873889, day: 3, type: 'museum', img: commonsImg('Utsunomiya_museum.jpg'), ticket: 'เช็คราคาที่เว็บ (⚠️ นิทรรศการ Magritte เปิด 24 ต.ค. — ไม่ทันวันที่แวะ เห็นแค่คอลเลกชันถาวร)', url: 'https://u-moa.jp/', desc: 'Architecture · Shinichi Okada & Associates — กลุ่มห้องจัดแสดงเชื่อมด้วยโถงกลาง ดูจังหวะอาคารกับป่าใน Bunka no Mori Park — งาน Magritte, Chagall และคอลเลกชันดีไซน์ บัส ~25 นาทีจากฝั่งตะวันตกสถานี Utsunomiya',
    en: { name: 'Utsunomiya Museum of Art', ticket: 'Check prices online (⚠️ the Magritte show opens 24 Oct — after our visit, so permanent collection only)', desc: 'Architecture · Shinichi Okada & Associates — gallery wings linked by a central hall; study how the building meets the woods of Bunka no Mori Park — Magritte, Chagall and a design collection. ~25 min by bus from the west side of Utsunomiya Sta.' } },
  ...
  // Nikko
  { name: 'ศาลเจ้า Toshogu', architecture: true, ja: '日光東照宮', area: 'nikko', lat: 36.7581, lng: 139.5986, day: 2, desc: 'มรดกโลก สุสานโชกุน Tokugawa Ieyasu — แกะสลักแมวหลับ/ลิงสามตัว',
  ...
  { name: 'Lake Inawashiro · Nagahama', ja: '猪苗代湖・長浜', area: 'fukushima', lat: 37.52153, lng: 140.04661, day: 4, type: 'spot', url: 'https://www.bandaisan.or.jp/fun/nagahama-2/', ticket: 'ริมทะเลสาบฟรี · เรือชมวิว ~30 นาที ผู้ใหญ่ ¥1,500 (เงินสด/PayPay)', desc: '🦢 หมุดที่ Nagahama คือจุดลงรถและท่าเรือจริงของทะเลสาบ “กระจกสวรรค์” · จาก Fukushima ต่อรถที่ Koriyama และ Inawashiro ใช้รวมราว 2–3 ชม./เที่ยว · 23 ต.ค. ใช้บัส Kin no Hashi ¥540; 24–25 ต.ค. ใช้รถท่องเที่ยว Hideyo-kun ¥500 · บทความปี 2019 ระบุ ¥450 ซึ่งไม่ใช่ราคาปี 2026 แล้ว · ปลาย ต.ค. อาจเริ่มเห็นหงส์บางส่วน แต่ฤดูหลักคือ พ.ย.–เม.ย.', en: { name: 'Lake Inawashiro · Nagahama', ticket: 'Lakeside free · ~30 min sightseeing cruise ¥1,500 adult (cash/PayPay)', desc: '🦢 This pin marks Nagahama, the actual bus stop and sightseeing-boat pier on the “Heavenly Mirror” lake. From Fukushima, transfer at Koriyama and Inawashiro; allow roughly 2–3 hours each way. Use the ¥540 Kin no Hashi bus on Fri 23 Oct or the ¥500 Hideyo-kun loop on the weekend. The ¥450 fare in the 2019 article is outdated.' } },
...
const TRANSPORT = [
  ...
  { title: 'Fukushima Station ⇄ Lake Inawashiro · Nagahama', day: 'DAY 4 · 23 ต.ค. / สำรอง 24–25 ต.ค.', options: [
    { method: '🚃 แนะนำวันศุกร์ 23 · รถธรรมดา + บัส Kin no Hashi (ไป-กลับ)', note: 'Fukushima → Koriyama รถ JR Tohoku Line ~50 นาที ¥990 · ต่อ JR Ban\'etsu West Line → Inawashiro ~35–40 นาที ¥770 · บัสหน้าสถานี → Nagahama 9 นาที ¥540 · ขาไปบัส 09:28 / 12:18 / 15:08 / 16:38 / 18:53; ขากลับจาก Nagahama 10:49 / 13:49 / 15:44 / 17:19 · เผื่อเวลาต่อรถเพราะขบวน JR ห่าง', time: '~2–3 ชม./เที่ยว', price: 4600 },
    { method: '⚡ เร็วขึ้นวันศุกร์ 23 · Shinkansen ถึง Koriyama + รถไฟ/บัส (ไป-กลับ)', note: 'เปลี่ยนขา Fukushima → Koriyama เป็น Tohoku Shinkansen ~12 นาที ~¥1,800 แล้วต่อ Ban\'etsu West Line และบัส Kin no Hashi เหมือนเดิม · ประหยัดเวลานั่งรถ แต่ยังต้องรอตารางต่อรถที่ Koriyama/Inawashiro', time: '~1 ชม. 40 นาที–2 ชม. 30 นาที/เที่ยว', price: 6220 },
    { method: '🚌 สำรองเสาร์–อาทิตย์ 24–25 · รถท่องเที่ยว Hideyo-kun (ไป-กลับ)', note: 'บัสปกติหยุดวิ่งช่วงสุดสัปดาห์ 18 ก.ค.–8 พ.ย. 2026 · ใช้ Hideyo-kun จาก Inawashiro Sta. 10:05 / 11:05 / 12:05 / 13:10 / 14:10 / 15:10 ถึง Nagahama ใน 9 นาที · ¥500/เที่ยว หรือ day pass ¥1,200 ถ้าจะแวะ Tenkyokaku/พิพิธภัณฑ์ Noguchi Hideyo', time: '~2–3 ชม./เที่ยวจาก Fukushima', price: 4520 },
  ], links: [
    { label: 'รีวิว JapanKakkoii (ข้อมูลปี 2019)', url: 'https://www.japankakkoii.com/japan-travel/lake-inawashiro-fukushima/' },
    { label: 'ตารางบัสวันธรรมดา 2026', url: 'https://www.bandaisan.or.jp/new_bandaisanorjp/wp-content/uploads/2026/07/%E8%B7%AF%E7%B7%9A%E3%83%90%E3%82%B9%EF%BC%8F%E9%87%91%E3%81%AE%E6%A9%8B%E7%B7%9A%E6%99%82%E5%88%BB%E8%A1%A8.pdf' },
    { label: 'Hideyo-kun 2026 (เสาร์–อาทิตย์)', url: 'https://www.bandaisan.or.jp/news/news-20252/' },
    { label: 'เช็ครอบ JR Inawashiro', url: 'https://timetables.jreast.co.jp/timetable/list0151.html' },
  ]},
...
const CAR_PLAN = {
  ...
  fuel: 4000,              // 23: ทางด่วนไป Urabandai ไป-กลับ · 24: ขึ้น Bandai-Azuma Skyline ไป Jododaira
